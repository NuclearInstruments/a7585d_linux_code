...
enum HVFeedbackMode	{HVFB_digital=0, HVFB_analog=1, HVFB_temperature=2};
...
void GetNIPMRegFloat		(int dev, int device_address, uint8_t register_n, float *data);
void GetNIPMRegBoolean		(int dev, int device_address, uint8_t register_n, bool *data);
void GetNIPMRegInteger		(int dev, int device_address, uint8_t register_n, int32_t *data);
